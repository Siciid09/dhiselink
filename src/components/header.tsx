...
import { ChevronDown, Briefcase, Building, Home, Info, Users, LucideProps, LogIn, UserPlus, Landmark } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { name: 'Professionals', href: '/professionals', icon: Users },
  {
    ...
    dropdown: [
      ...
      // UPDATED href for both items
      { name: 'Government', href: '/government-ngos', description: 'Public sector and state institutions' },
      { name: 'NGOs & Others', href: '/government-ngos', description: 'Non-governmental & other entities' },
    ],
  },
  {
    name: 'Opportunities',
    ...
    dropdown: [
      ...
      // MOVED Heritage inside this dropdown
...
// --- Animated Hamburger Icon Component (Animates to "X" when open) ---
