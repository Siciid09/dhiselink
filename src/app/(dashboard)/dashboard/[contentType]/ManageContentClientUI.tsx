// src/app/(dashboard)/dashboard/[contentType]/ManageContentClientUI.tsx
"use client";
...
import { manageContent } from '../create/actions';
...
export default function ManageContentClientUI({ initialItems, contentType, contentConfig }: { initialItems: any[], contentType: string, contentConfig: any }) {
