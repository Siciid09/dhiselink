...
import { deleteOpportunity } from '../create/actions';
                            ...
                            <form action={handleDelete}>
                                ...
                                <div className="flex justify-end gap-3 mt-6">
                                    <button 
                                        ...
                                        className="px-5 py-2 font-semibold text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors"
                                    >
                                        Cancel
                                    </button>
                                    <button 
                                        type="submit" 
                                        disabled={isPending}
                                        className="px-5 py-2 font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center gap-2 disabled:bg-red-400 w-28"
                                    >
