...
export default function CompanyOnboardingPage() {
    const [state, formAction] = useFormState(completeCompanyOnboarding, { error: null });
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-lg bg-white rounded-2xl shadow-xl border p-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-600">Tell us about your company to get started.</p>
                </div>
                <form action={formAction} className="mt-8 space-y-5">
                    ...
                    <div>
                        <label className="font-medium text-gray-700">Company Website</label>
                        <div className="relative mt-1">
