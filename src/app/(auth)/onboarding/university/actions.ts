...
export async function completeUniversityOnboarding(prevState: ActionState, formData: FormData): Promise<ActionState> {
    ...
    if (!organizationName || !websiteUrl || !employeeCount) { return { error: "Please fill out all fields." }; }
