    ...
    <section className="relative bg-gray-50 pt-48 pb-32 text-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            <motion.h1
                ...
                className="text-4xl md:text-6xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-gray-900 to-gray-600 leading-tight mb-4"
            >
                We are Building the Future of Somalia, Together.
            </motion.h1>
            <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                Dhiselink was born from a simple but powerful idea: to create a central hub where Somalia's brightest minds could connect with the opportunities to rebuild and redefine our nation.
            </motion.p>
        </div>
    </section>
);
    ...
    <AnimatedSection className="bg-white">
        <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants}>
                ...
                <p className="text-gray-600 text-lg">To accelerate Somalia's development by creating a transparent, efficient, and collaborative digital ecosystem that connects skilled professionals with impactful opportunities across all sectors.</p>
            </motion.div>
            <motion.div variants={itemVariants}>
                <div className="flex items-center gap-4 mb-4">
                ...
                <p className="text-gray-600 text-lg">To be the foundational platform for nation-building in Somalia, fostering innovation, retaining local talent, and enabling the successful execution of projects that lead to a prosperous and sustainable future.</p>
            </motion.div>
        </div>
    </AnimatedSection>
);
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <motion.div variants={itemVariants} className="lg:w-1/2">
                <img
                    ...
                    alt="Team of builders and planners collaborating on a project"
...
export default function AboutPage() {
    return (
        <>
            ...
            <StorySection />
            <ValuesSection />
            {/* You can add the TeamSection here if you wish */}
            <style jsx global>{`
