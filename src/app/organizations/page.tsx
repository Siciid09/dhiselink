...
// OrgProfile, iconMap, and OrgCard components remain the same...
type OrgProfile = {
  id: string;
  slug: string;
...
export default function OrganizationsPage() {
    ...
    // The tab state now initializes correctly on first load
    ...
    // --- CHANGE 1: Added useEffect to sync tab with URL changes ---
    // This makes the component "smart" by watching for URL changes
    // and updating the active tab accordingly.
    useEffect(() => {
    ...
    return (
        <div className="bg-slate-50 min-h-screen">
            {/* --- CHANGE 2: Reduced top padding and bottom margin to remove gaps --- */}
